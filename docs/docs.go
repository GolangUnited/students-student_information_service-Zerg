    ...
    "paths": {
        ...
        "/courses/{course_id}/interview": {
            "get": {
                ...
                "operationId": "get-course-interview-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "course ID to get interview",
                        "name": "course_id",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.CourseInterview"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/group-contacts": {
            "get": {
                ...
                "operationId": "group-contacts-list",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.GroupContact"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "operationId": "create-group-contact",
                "parameters": [
                    {
                        "description": "group contact data",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/group-contacts/{group_contact_id}": {
            "get": {
                "security": [
                    {
                        "ApiToken": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "group contact data to update",
                        "name": "input",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "delete": {
                ...
                "operationId": "remove-group-contact-by-id",
                "parameters": [
                    {
                        "type": "integer",
